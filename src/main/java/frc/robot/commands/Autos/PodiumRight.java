...
public class PodiumRight extends SequentialCommandGroup {
  /** Creates a new AutoTwo. */
  public PodiumRight(Elevator objElevator, TilterV2 objTilter, SwerveSubsystem objSwerve, Feeder objFeeder, Shooter objShooter, Intake objIntake, boolean bFwd) {

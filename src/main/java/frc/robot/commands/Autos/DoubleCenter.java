...
public class DoubleCenter extends SequentialCommandGroup {
  /** Creates a new AutoTwo. */
  public DoubleCenter(Elevator objElevator, TilterV2 objTilter, SwerveSubsystem objSwerve, Feeder objFeeder, Shooter objShooter, Intake objIntake, boolean bFwd) {
    ...
    addCommands(
      ...
      new ParallelCommandGroup(
        new AutoDrive(objSwerve, -0.7, 0.0, -0.0),
      ...
      // new AutoDrive(objSwerve, 0.7, 0.0, 0).withTimeout(3.5)
    );
  }
}

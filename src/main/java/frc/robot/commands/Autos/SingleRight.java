...
public class SingleRight extends SequentialCommandGroup {
  /** Creates a new ShootAndMoveRight. */
  public SingleRight(Elevator objElevator, TilterV2 objTilter, SwerveSubsystem objSwerve, Feeder objFeeder, Shooter objShooter) {
    ...
    addCommands(
      ...
      new ParallelCommandGroup(
        new AutoDrive(objSwerve, -0.6, 0.5, 0.0).withTimeout(5.0),    // negative x move goes away from shoot direction
                                                                                                    // negative y move goes left

...
public class SingleStraight extends SequentialCommandGroup {
  /** Creates a new ShootAndMove. */
  public SingleStraight(Elevator objElevator, TilterV2 objTilter, SwerveSubsystem objSwerve, Feeder objFeeder, Shooter objShooter) {
    ...
    addCommands(
      ...
      new ParallelCommandGroup(
        new AutoDrive(objSwerve, -0.5, 0.0, 0.0),    // negative x move goes away from shoot direction

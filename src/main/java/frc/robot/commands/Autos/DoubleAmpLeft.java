...
public class DoubleAmpLeft extends SequentialCommandGroup {
  /** Creates a new AutoTwo. */
  public DoubleAmpLeft(Elevator objElevator, TilterV2 objTilter, SwerveSubsystem objSwerve, Feeder objFeeder, Shooter objShooter, Intake objIntake, boolean bFwd) {
    ...
    addCommands(
      ...
      new ParallelCommandGroup( 
        ...
        new IntakeNFeederRun(objElevator, objTilter, objFeeder, objIntake, objShooter, bFwd).withTimeout(2.0)
      ).withTimeout(3.0),

...
public class ShootStay extends SequentialCommandGroup {
  /** Creates a new AutoStop. */
  public ShootStay(Elevator objElevator, TilterV2 objTilter, SwerveSubsystem objSwerve, Feeder objFeeder, Shooter objShooter) {

...
public class ShooterAccel extends Command {
  private final Shooter objShooter;
  private final double dSpeed;

  /** Creates a new ShooterRun. */
  public ShooterAccel(Shooter objShooter_in, double dSpeedRPM_in) {
  ...
  public void end(boolean interrupted) {
    // objShooter.stopShooter();      // do not stop the shooter in the shooter accel command
  }

  // Returns true when the command should end.
  @Override
  public boolean isFinished() {
    return Math.abs(objShooter.getSpeed() - dSpeed) < 200.0;
  }
}
